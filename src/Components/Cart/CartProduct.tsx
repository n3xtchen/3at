...
export default function CartProduct(cartProduct: CartProduct) {

  const [product, setProduct] = useState<CartProduct>(cartProduct);
  ...
  return <div key={product.id} className='row justify-content-around  my-2 px-0 py-4 cart-item align-items-center py-2 border-bottom'>
