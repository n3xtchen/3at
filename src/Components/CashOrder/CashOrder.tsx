...
<form onSubmit={formik.handleSubmit} onBlur={formik.handleBlur}>
    ...
    {isLoading?<button  className='bg-main btn text-white mt-2 w-100'><i className='fas fa-spinner fa-spin'></i></button>:<button disabled = {!(formik.isValid && formik.dirty)} type='submit' className='bg-main btn text-white mt-2 w-100'>Pay Cash</button>}
